...
custom_replacements = {
  ...
  */
  names = {
    ...
    management_resource_group_name = "rg-bdo3management-$${starter_location_01}"
    asc_export_resource_group_name = "rg-bdo3asc-export-$${starter_location_01}"
